export const users = {
  ...
  bio: "Nothing much to write here",
  password: 12345678,
...
export const handleLikeToggle =async (postId: string, newLikestatus:boolean) => {
  try {
...
export const handleBookmarkToggle = async (postId:string, newBookmarkStatus:boolean) => {
try {
// Step 1: Fetch existing data
const response = await fetch(`https://react-http-2faf5-default-rtdb.firebaseio.com/post/${postId}.json`);
